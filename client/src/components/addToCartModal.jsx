          ...
          <div className="p-5">
            ...
            <div className="flex gap-3">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="flex-1 py-2.5 bg-yellow-500 hover:bg-yellow-600 text-white rounded-xl font-bold transition-colors disabled:opacity-60 flex items-center justify-center gap-2"
              >
                {loading ? (
