  ...
  en: {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          '"Check the 30-day market price history based on Department of Agriculture data. This helps you track trends and ensure fair pricing."',
        route: "/homepage",
        target: "market-info",
      },
      {
...
const SELECTORS = {
  navbar:
    '[data-tutorial="mobile-bottom-bar"], nav[class*="bg-green-800"], nav[class*="green"]',
  "navbar-search":
    '[data-tutorial="mobile-search-btn"], [data-tutorial="desktop-search-btn"], nav input[type="text"]',
  "navbar-notifications":
    '[data-tutorial="mobile-tab-alerts"], nav button[title="Notifications"]',
  "navbar-cart":
    '[data-tutorial="mobile-tab-cart"], nav button[title="My Cart"], nav button[title="Cart"], nav a[href="/cart"]',
  "navbar-chat":
    '[data-tutorial="mobile-tab-chat"], nav button[title="Messages"]',
...
function Card({
  ...
  const vw = window.innerWidth;
  const W = vw >= 768 ? 480 : Math.min(310, vw - 32);
  const pos = isCentered ? { top: "50%", left: "50%", _w: W } : cardPos(rect);
